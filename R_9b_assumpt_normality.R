...
# -> all good: point estimate unbiased, SE ok
# also: p-values all very small, all smaller than 0.05
...
# -> all good: point estimate unbiased, SE ok
# also: p-values all very small, all smaller than 0.05, but larger than in scenario 1
...
# -> all good: point estimate unbiased, SE ok
# also: many p-values small, not all smaller than 0.05, and larger than in scenario 1 and 2
...
# -> all relatively ok: point estimate unbiased, SE slightly underestimated
# also: many p-values small, not all smaller than 0.05, and larger than in scenario 1 and 2
...
# -> point estimate biased, SE much underestimated
# also: many p-values not smaller than 0.05
